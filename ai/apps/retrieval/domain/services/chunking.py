...
2026-09-09 실측: 조항 98개, 중앙값 120자 / 최대 311자 / 400자 초과 0건 → 현재 지식베이스에서
분할은 일어나지 않는다. 상한은 문서가 길어질 때를 대비한 안전장치다.
(2026-08-26 4개 도메인 시절에는 조항 102개 / 중앙값 101자 / 최대 332자였다. 08-28 다산
단일화로 20개까지 줄었다가 09-09 에 다산 안에서 98개로 늘어난 것이다 — `decisions/201`.)
"""
