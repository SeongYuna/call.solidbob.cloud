...
주 담당: **정성윤**(AWS·인프라·CI 운영). **잠금은 아니다** — `infra/` 는 정성윤·류준·장민석
누구나 고친다(2026-09-10, `../_project/decisions/302`). 다만 여기는 **비용과 운영 자원이 걸린
디렉터리**라, 담당자든 아니든 **`../docs/infra-runbook.md` 를 먼저 읽고 아래 §1 「절대 지킬 것」을
지킨다** — `infra_runbook_guard.py` 훅이 그대로 강제한다. 되돌리기 어려운 변경(자원 생성·삭제)은
정성윤과 말로 맞춘다.
