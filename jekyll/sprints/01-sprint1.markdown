...
> ⚠ **스프린트 페이지는 이 1주차 한 장으로 끝난다 (2026-09-23 정리).** 2주차부터는 같은 내용을
> **진행 기록**([`/progress/`](/progress/) — 항목 1건 = 파일 1개)과 **주차 목표**([8주 마일스톤](/docs/08/)),
> **칸반**([`/kanban/`](/kanban/))이 나눠 갖는다. 같은 것을 세 곳에 적지 않는다는 규칙(`CLAUDE.md` §4) 때문에
> 이 페이지만 남기고 2~8주차는 만들지 않는다. 이 장은 1주차의 기록이라 그대로 둔다(절대 원칙 8).
