...
- ✅ **09-18 처리 결과(같은 날 2차)** — ①②④⑤⑥⑦ 반영 후 E2E **24건 ✅22·❌2**(`data/processed/persona-e2e/2026-09-18-1653.md`·`1655.md`). 남은 ❌ 2 = **SYN-011(3.14)·021(2.9) 검색 순위** — BM25 상위 5 에 정답 조항이 없어 필요서류 판정이 없다 → `decisions/208`(운영 임베딩). ③ 은 「카드 순서대로 규칙 있는 첫 조항」으로 바꿨다(콜 미디에이터 `0.2.1`)
...
- [ ] **합성 대본 24건 사람 검토 — 류준·팀** — `w5-persona-sim-scripts` 를 닫으며 여기로. 매뉴얼 5.2 종료·5.4 위기 응대 해석과 어눌한 한국어 과장 여부는 AI 검수(QA 페르소나 3종)만 거쳤다. 시연 대본 SYN-004·010·020 부터.
