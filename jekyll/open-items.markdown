...
- [ ] **학습한 모델을 어디에·어떻게 올리는가 (신규, 2026-09-14)** — 모델 학습은 **정성윤 님이 SSH 로 개인 컴퓨터에서 돌리고
