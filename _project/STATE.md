...
> (`w6-core-baseline-check`). ⚠ **판정에 쓸 공식 수치가 아래 「실측값」의 09-09 값뿐이다** — 그 뒤 들어온
> dense·리랭커·NER·C-5 규칙 보강은 **로컬 측정이고 하네스 기록이 아니다.** 재측정이 먼저다.
