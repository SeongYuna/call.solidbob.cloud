...
EXCLUDED: dict[str, str] = {
    ...
    # 2026-09-22 류준(`decisions/217`) — 규칙표 항목은 장민석 검토 뒤. 넣기 전에 dense 끼어듦을 먼저 본다.
    "DASAN-TERM-4.23": "성인·미성년·분실 갈래마다 서류가 다르다 — 그리고 dense 에서 여권과 무관한 질문(운전면허 갱신 GS-702 등)의 "
    "1순위로 끼어들어, 규칙을 붙이면 1순위 절차 규칙(`w6-procedure-pick-rule`) 때문에 거짓 「빠진 서류」가 뜬다",
}
