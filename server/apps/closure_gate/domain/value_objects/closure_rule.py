...
EXCLUDED: dict[str, str] = {
    ...
    "DASAN-TERM-2.6": "경로·장애인·국가유공자 우대용마다 기본 서류가 다르다",
    "DASAN-TERM-3.4": "신청과 해지의 서류가 다르다",
    "DASAN-TERM-3.6": "감면 대상별로 자격 증명서가 다르다 — 대상을 먼저 확인한다",
    "DASAN-TERM-4.5": "용도에 따라 필요 서류가 달라진다 — 용도를 먼저 확인한다",
    "DASAN-TERM-4.9": "부동산과 차량의 서류가 다르다",
    "DASAN-TERM-4.12": "감면 사유별로 요구 서류가 다르다",
